...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfigTBL_capsense0_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration capsense0
;
;    Load configuration registers for capsense0.
...
;               CUR_PP
;
_LoadConfig_capsense0:
 LoadConfig_capsense0:
    RAM_PROLOGUE RAM_USE_CLASS_4
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_capsense0_Bank0
    mov     X, <LoadConfigTBL_capsense0_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_capsense0_Bank1
    mov     X, <LoadConfigTBL_capsense0_Bank1
